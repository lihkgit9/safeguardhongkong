$(function () {
    ...
    function submitHandle(o){
    	...
    	xhr.send('&username=' + o.username + '&hkcode=' + o.hkcode + '&yzm=' + o.yzm + '&sector=' + o.sector + '&tel=' + o.tel);
    }
    ...
    function getData() {
    	$.get("get_data.php", function (data) {
            ...
            $("#month").text(data.end_date[1]);
            $("#day").text(data.end_date[2]);
			$("#hour").text(data.end_time[0]);
